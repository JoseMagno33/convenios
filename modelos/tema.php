<?php
	   ...
	   class Tema extends Conectar{


      public function get_filas_tema(){

             $conectar= parent::conexion();
           
             $sql="select * from cmx_tema";
       ...
       //método para seleccionar registros
        ...
        public function registrar_tema($tema, $id_usuario){

           
           $conectar= parent::conexion();
           parent::set_names();

           $sql="insert into tema (tema,id_usuario)
           values(?,?,?);";
