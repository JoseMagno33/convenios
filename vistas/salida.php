              ...
              <div class="col-md-12">
                  <div class="box">
                    <div class="box-header with-border">
                          <h1 class="box-title">
                            <button class="btn btn-primary btn-lg" id="add_button" onclick="limpiar()" data-toggle="modal" data-target="#clienteModal"><i class="fa fa-plus" aria-hidden="true"></i> Nueva Salida</button></h1>
                    ...
                    <div class="panel-body table-responsive">
                          ...
                          <table id="salida_data" class="table table-bordered table-striped">
