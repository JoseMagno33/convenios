     ...
     foreach($datos as $row)

			{
				$sub_array = array();
                 ...
                 $sub_array[] = '<button type="button" onClick="ventasalida('.$row["id_salida"].');" id="'.$row["id_salida"].'" class="btn btn-success btn-md"><i class="glyphicon glyphicon-edit"></i> Ventas</button>';
